...
namespace RPCommands.API
{
    ...
    {
        private static readonly Dictionary<string, Dictionary<string, float>> _cooldowns = [];
        ...
        public static void SetCooldown(this Player player, string command, float duration)
        {
        ...
        public static bool HasCooldown(this Player player, string command)
        {
        ...
        public static float GetRemainingCooldown(this Player player, string command)
        {
            if (!_cooldowns.TryGetValue(player.UserId, out var commands))
                return 0f;
        ...
        public static void ClearCooldown(this Player player, string command)
        {
            if (_cooldowns.TryGetValue(player.UserId, out var commands))
