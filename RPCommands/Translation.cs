...
public class Translation
{
    ...
    public string RadioRequired { get; set; } = "You must have a radio in your inventory to use this command.";
    ...
    [Description("Message for players who healed a target using adrenaline.")]
    public string AdrenalineHeal { get; set; } = "<color=yellow>{0}</color> gave you an adrenaline shot!";
    [Description("Message for players who healed a target using painkillers.")]
    public string PainkillersHeal { get; set; } = "<color=yellow>{0}</color> gave you painkillers!";
    ...
    [Description("Message shown when a player successfully uses the suicide command.")]
    public string SuicideSuccess { get; set; } = "You have taken your own life.";
    [Description("Message shown on player's body after using suicide command")]
    public string DeathReason { get; set; } = "Suicide";
    ...
    {
        return Main.Instance.Config.Translation.CommandNames
