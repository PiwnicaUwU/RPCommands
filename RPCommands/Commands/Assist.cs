...
internal sealed class AssistCommand : InternalRPCommand
{
    ...
    protected override bool ExecuteAction(Player player, string message, out string response)
    {
        ...
        foreach (var players in Player.ReadyList.Where(p => p.RemoteAdminAccess))
        {
            players.SendStaffMessage(FormatMessage(player, message), EncryptedChannelManager.EncryptedChannel.AdminChat);
        }
