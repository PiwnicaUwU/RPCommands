...
namespace RPCommands
{
    public sealed class Translation : ITranslation
    {
        ...
        public string Usage { get; set; } = "Usage: .{command} <message>";
        ...
        public string FormatMessage { get; set; } = "{nickname}: {message}";

        [Description("Format for try command messages.")]
        public string FormatTryMessage { get; set; } = "{nickname}: {message} ({result})";
