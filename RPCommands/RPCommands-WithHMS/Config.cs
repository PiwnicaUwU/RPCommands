...
namespace RPCommands_WithoutHSM
{
    public class Config : IConfig
    {
        ...
        public CommandSettings Me { get; set; } = new(15f, 5f, "<align=left><color=green>「Me」</color><color=#FFFF00>{0}</color> : {1}</align>");
        public CommandSettings Do { get; set; } = new(15f, 5f, "<align=left><color=green>「Do」</color><color=#FFFF00>{0}</color> : {1}</align>");
        public CommandSettings Look { get; set; } = new(15f, 5f, "<align=left><color=green>「Look」</color><color=#FFFF00>{0}</color> : {1}</align>");
        public CommandSettings Ooc { get; set; } = new(15f, 5f, "<align=left><color=green>「Ooc」</color><color=#FFFF00>{0}</color> : {1}</align>");
        public CommandSettings Try { get; set; } = new(15f, 5f, "<align=left><color=green>「Try」</color><color=#FFFF00>{0}</color> : tried to {1} and {2} did it!</align>");
