...
[
    ...
    [Description("If true, SCPs are allowed to use the .suicide command.")]
    public bool AllowScpSuicide { get; set; } = false;
    public CommandSettings Suicide { get; set; } = new(CommandHandlerType.Client, 0f, 0f, 0f, "");
